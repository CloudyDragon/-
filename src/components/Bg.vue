<template>
  <div id="bg">
      <canvas class="canvas canvas-pattern js-canvas" width="500px" height="500px"></canvas>
      <canvas class="canvas js-duplicate" width="500px" height="500px"></canvas>
      <div class="describe">
         <canvas id="colour-font" width="500px" height="50px"></canvas>
      </div>
  </div>
</template>
...
export default {
  ...
  mounted: function() {
    this.$nextTick(function() {
      ...
      //描述
      var colourFont = document.getElementById('colour-font')
      var grd = ctx.createLinearGradient(200, 0, 400, 0)
      grd.addColorStop(0, '#00ff33')
      grd.addColorStop(1, 'aqua')
      var describe = colourFont.getContext('2d')
      describe.strokeStyle = grd
      describe.font = `30px '华文楷体'`
      describe.strokeText('(╯°Д°)╯ ┻━┻ 兴趣使然的小站！', 10, 30)
    })
  }
}
</script>
